...
value class Amount(
    ...
    fun isAffordable(manualQuantity: Int): Boolean = amount - manualQuantity * LOTTO_EACH_AMOUNT >= 0

    fun getAutoLottoQuantity(manualQuantity: Int): Int = amount / LOTTO_EACH_AMOUNT - manualQuantity
