...
object OutputView {
    ...
    fun printPurchaseResult(manualPurchaseCount: Int, purchaseCount: Int, lottoBunch: LottoBunch) {
        printPurchaseCount(manualPurchaseCount, purchaseCount)
    ...
    private fun printPurchaseCount(manualPurchaseCount: Int, purchaseCount: Int) {
        println(PURCHASE_COUNT_SCRIPT.format(manualPurchaseCount, purchaseCount))
    }
}
