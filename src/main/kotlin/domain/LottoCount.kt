...
class LottoCount(val manualCount: Count, val totalCount: Count) {
    ...
    companion object {
        private const val MANUAL_LOTTO_COUNT_ERROR_MESSAGE = "[ERROR] 수동 로또 개수가 총 로또 개수보다 많을 수 없습니다."
        private const val ZERO = 0
        private const val TOTAL_LOTTO_COUNT_ERROR_MESSAGE = "[ERROR] 총 로또 개수가 0이 될순 없습니다"
    }
}
