...
class ConsoleLottoGameInputView : LottoGameInputView {
    ...
    companion object {
        ...
        private const val EXCEPTION_NULL = "을(를) 입력하지 않았습니다."
        private const val EXCEPTION_PURCHASE_EXPENSE = "로또 구매 금액$EXCEPTION_NULL"
        private const val EXCEPTION_WINNING_NUMBER = "당첨 번호$EXCEPTION_NULL"
        private const val EXCEPTION_BONUS_NUMBER = "보너스 번호$EXCEPTION_NULL"
    }
}
