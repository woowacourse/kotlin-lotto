...
class LottoViewTest {
    ...
    fun t1() {
        assertThat(LottoView.requireLottoAmount("5000")).isEqualTo(5)
    }

    @Test
    @DisplayName("예를 들어 14500원을 입력받는다면 14000으로 로또 14개를 살 수 있으니 14개를 구매한다")
    fun t1_1() {
        assertThat(LottoView.requireLottoAmount("14500")).isEqualTo(14)
    }

    @Test
    @DisplayName("숫자로 변환할 수 없는 값을 입력받는다면 IllegalArgumentException를 반환하고, \"올바르지 않은 형식입니다\" 라는 메시지를 출력한다\n")
    fun t1_2() {
        assertThatThrownBy { LottoView.requireLottoAmount("1dw") }
    ...
    fun t2() {
        assertThat(LottoView.requireValidLotto("1,2,3,4,5,6"))
    ...
    fun t2_1() {
        assertThatThrownBy { LottoView.requireValidLotto("1,2,3,4,5,2ㅂ34") }
            .isInstanceOf(IllegalArgumentException::class.java)
            .hasMessage("올바르지 않은 형식입니다")
    }
    ...
    fun t2_2() {
        assertThatThrownBy { LottoView.requireValidLotto("1,2,3,4,5,6,7") }
            .isInstanceOf(IllegalArgumentException::class.java)
    ...
    fun t2_3() {
        assertThatThrownBy { LottoView.requireValidLotto("1,2,300,4,5,6") }
            .isInstanceOf(IllegalArgumentException::class.java)
    ...
    fun t2_4() {
        assertThatThrownBy { LottoView.requireValidLotto("1,2,3,4,5,5") }
            .isInstanceOf(IllegalArgumentException::class.java)
    ...
    fun t3() {
        assertThat(LottoView.requireValidBonusNum("6"))
            .isEqualTo(6)
    }
    ...
    @DisplayName("  - 숫자로 변환할 수 없는 값을 입력받는다면 IllegalArgumentException를 반환하고, \"올바르지 않은 형식입니다\" 라는 메시지를 출력한다\n")
    fun t3_1() {
        assertThatThrownBy { LottoView.requireValidBonusNum("11r") }
            .isInstanceOf(IllegalArgumentException::class.java)
            .hasMessage("올바르지 않은 형식입니다")
    }
    ...
    fun t3_2() {
        assertThatThrownBy { LottoView.requireValidBonusNum("2345") }
            .isInstanceOf(IllegalArgumentException::class.java)
            .hasMessage("1부터 45까지의 숫자를 입력해주세요")
    }
    ...
    @DisplayName("  - 1부터 45 사이의 숫자를 입력받지 않는다면 IllegalArgumentException을 반환하고 \"1부터 45까지의 숫자를 입력해주세요\" 라는 메시지를 출력한다\n")
    fun t3_2_1() {
        assertThatThrownBy { LottoView.requireValidBonusNum("-1") }
            .isInstanceOf(IllegalArgumentException::class.java)
            .hasMessage("1부터 45까지의 숫자를 입력해주세요")
    }
