...
# 2단계 (수동)
## 도메인
- [ ] 로또 주문은 로또 수동 개수와 자동 로또 개수를 가진다.

## 뷰
- [ ] 사용자로부터 구매할 로또 수를 입력 받는다
- [ ] 사용자로부터 구매할 번호를 구매할 로또 수만큼 반복하여 입력 받는다.
- [ ] 수동 구매 로또 개수와 자동 구매 로또 개수를 출력한다.
- [ ] 수동 구매 로또 번호와 자동 구매 로또 번호를 출력한다.